package com.example.packagemanagerservice.aspect;
...
import com.example.packagemanagerservice.listener.IPermission;
...
import com.example.packagemanagerservice.util.PermissionUtils;
...
public class PermissionAspect {
    ...
    // 仅仅是只能找到这个函数
    @Pointcut
    ("execution(@com.example.packagemanagerservice.permission.Permission * *(..)) && @annotation(permission)") //  @Permission == permission
