...
public class PackageParser {
    ...
    /**
     * Standard implementation of {@link Callback} on top of the public {@link android.content.pm.PackageManager}
     * class.
     */
    ...
    private static boolean checkUseInstalledOrHidden(int flags, PackageUserState state,
        ...
        return state.isAvailable(flags)
                || (appInfo != null && appInfo.isSystemApp()
                        && (flags & android.content.pm.PackageManager.MATCH_KNOWN_PACKAGES) != 0);
    }
    ...
    private static ApkLite parseApkLite(String codePath, XmlPullParser parser, AttributeSet attrs,
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            if (TAG_PACKAGE_VERIFIER.equals(parser.getName())) {
                ...
                if (usesSplitName == null) {
                    throw new PackageParserException(
                            android.content.pm.PackageManager.INSTALL_PARSE_FAILED_MANIFEST_MALFORMED,
    ...
    public final static class Package implements Parcelable {
        ...
        public long getLatestForegroundPackageUseTimeInMills() {
            int[] foregroundReasons = {
                ...
                android.content.pm.PackageManager.NOTIFY_PACKAGE_USE_FOREGROUND_SERVICE
            };
    ...
    private static void updateApplicationInfo(ApplicationInfo ai, int flags,
        ...
        if (state.enabled == android.content.pm.PackageManager.COMPONENT_ENABLED_STATE_ENABLED) {
            ai.enabled = true;
        } else if (state.enabled == android.content.pm.PackageManager.COMPONENT_ENABLED_STATE_DISABLED_UNTIL_USED) {
            ai.enabled = (flags& android.content.pm.PackageManager.GET_DISABLED_UNTIL_USED_COMPONENTS) != 0;
        } else if (state.enabled == android.content.pm.PackageManager.COMPONENT_ENABLED_STATE_DISABLED
                || state.enabled == android.content.pm.PackageManager.COMPONENT_ENABLED_STATE_DISABLED_USER) {
            ai.enabled = false;
        }
    ...
    public static ApplicationInfo generateApplicationInfo(Package p, int flags,
        ...
        if (!copyNeeded(flags, p, state, null, userId)
                && ((flags& android.content.pm.PackageManager.GET_DISABLED_UNTIL_USED_COMPONENTS) == 0
                        || state.enabled != android.content.pm.PackageManager.COMPONENT_ENABLED_STATE_DISABLED_UNTIL_USED)) {
    ...
    public static final ProviderInfo generateProviderInfo(Provider p, int flags,
        ...
        if (!copyNeeded(flags, p.owner, state, p.metaData, userId)
                && ((flags & android.content.pm.PackageManager.GET_URI_PERMISSION_PATTERNS) != 0
